...
<li><a href="#orgheadline8">2. Usage</a>
<ul>
...
<li><a href="#orgheadline7">2.6. Using <code>mirtarbase</code> in the <code>AnnotationDbi</code> framework</a></li>
</ul>
</li>
<li><a href="#orgheadline9">3. Database layout</a></li>
...
## Using `mirtarbase` in the `AnnotationDbi` framework<a id="orgheadline7"></a>
...
# Database layout<a id="orgtarget1"></a><a id="orgheadline9"></a>
...
# References<a id="orgheadline10"></a>
